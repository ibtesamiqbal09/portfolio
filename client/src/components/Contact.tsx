    ...
    <section id="contact" className="py-20 bg-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {/* Email */}
          <div className="bg-slate-900 p-8 rounded-xl border border-slate-700 card-hover text-center">
            ...
            <a
              ...
              className="text-primary-500 hover:text-primary-400 transition-colors font-medium break-all"
            >
              muhammadibtesam51@gmail.com
            </a>
          </div>
          ...
          <div className="bg-slate-900 p-8 rounded-xl border border-slate-700 card-hover text-center">
            ...
            <p className="text-slate-400 mb-4">Connect professionally</p>
            <a
          ...
          <div className="bg-slate-900 p-8 rounded-xl border border-slate-700 card-hover text-center">
            ...
            <h3 className="text-lg font-bold text-slate-100 mb-2">GitHub</h3>
            <p className="text-slate-400 mb-4">View my projects</p>
            <a
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-primary-500 to-accent-purple p-8 rounded-xl max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold text-white mb-4">
              Ready to Collaborate?
            </h3>
            <p className="text-slate-200 mb-6">
              I'm always open to discussing new opportunities, innovative
              projects, or just sharing knowledge about technology.
            </p>
            <a
              href="mailto:muhammadibtesam51@gmail.com"
              className="bg-white text-slate-900 px-8 py-3 rounded-lg font-semibold hover:bg-slate-100 transition-colors inline-flex items-center"
            >
              <svg
